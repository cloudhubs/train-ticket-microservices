...
import com.cloudhubs.trainticket.order.entity.NotifyInfo;
import com.cloudhubs.trainticket.order.entity.Ticket;
import com.cloudhubs.trainticket.order.entity.Consign;
import com.cloudhubs.trainticket.order.entity.Contacts;
import com.cloudhubs.trainticket.order.entity.TripAllDetail;
import com.cloudhubs.trainticket.order.entity.TripAllDetailInfo;
import com.cloudhubs.trainticket.order.entity.OrderTicketsInfo;
import com.cloudhubs.trainticket.order.entity.Seat;
import com.cloudhubs.trainticket.order.entity.SeatClass;
import com.cloudhubs.trainticket.order.entity.TravelResult;
import com.cloudhubs.trainticket.order.entity.Assurance;
import com.cloudhubs.trainticket.order.entity.User;
import com.cloudhubs.trainticket.order.entity.Order;
import com.cloudhubs.trainticket.order.entity.TripResponse;
import com.cloudhubs.trainticket.order.entity.Travel;
import com.cloudhubs.trainticket.order.entity.FoodOrder;
...
import com.cloudhubs.trainticket.order.mq.RabbitSend;
...
public class PreserveOtherServiceImpl implements PreserveOtherService {
    ...
    public Response preserve(OrderTicketsInfo oti, HttpHeaders httpHeaders) {
        ...
        HttpEntity requestEntity = new HttpEntity(query, HeadersUtils.prepareForSent(httpHeaders));
