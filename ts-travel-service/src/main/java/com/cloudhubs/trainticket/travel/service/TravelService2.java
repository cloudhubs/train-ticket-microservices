...
import com.cloudhubs.trainticket.travel.entity.TripInfo;
...
public interface TravelService2 {
    Response create(com.cloudhubs.trainticket.travel.entity.TravelInfo info, HttpHeaders headers);

    Response retrieve(String tripId, HttpHeaders headers);

    Response update(com.cloudhubs.trainticket.travel.entity.TravelInfo info, HttpHeaders headers);
    ...
    Response getTripAllDetailInfo(com.cloudhubs.trainticket.travel.entity.TripAllDetailInfo gtdi, HttpHeaders headers);
