package com.cloudhubs.trainticket.travel.service.impl;

import com.fasterxml.jackson.core.type.TypeReference;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.cloudhubs.trainticket.travel.entity.*;
import com.cloudhubs.trainticket.travel.repository.*;
...
import com.cloudhubs.trainticket.travel.util.JsonUtils;
...
public class TravelService2Impl implements TravelService2 {
    ...
    @Override
    public Response create(com.cloudhubs.trainticket.travel.entity.TravelInfo info, HttpHeaders headers) {
    ...
    @Override
    public Response update(com.cloudhubs.trainticket.travel.entity.TravelInfo info, HttpHeaders headers) {
        TripId ti = new TripId(info.getTripId());
    ...
    private TripResponse getTickets(Trip trip, Route route1, String startPlaceName, String endPlaceName, String departureTime, HttpHeaders headers) {
        ...
        ResponseEntity<Response<TravelResult>> re = restTemplate.exchange(
                ...
                HttpMethod.POST,
                requestEntity,
                new ParameterizedTypeReference<Response<com.cloudhubs.trainticket.travel.entity.TravelResult>>() {
                });
        Response r = re.getBody();
        if(r.getStatus() == 0){
