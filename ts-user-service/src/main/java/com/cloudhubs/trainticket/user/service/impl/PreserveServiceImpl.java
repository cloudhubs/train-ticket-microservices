...
import com.cloudhubs.trainticket.user.entity.Contacts;
import com.cloudhubs.trainticket.user.entity.Order;
import com.cloudhubs.trainticket.user.entity.TripResponse;
import com.cloudhubs.trainticket.user.entity.TripAllDetail;
import com.cloudhubs.trainticket.user.entity.TripAllDetailInfo;
import com.cloudhubs.trainticket.user.entity.SeatClass;
import com.cloudhubs.trainticket.user.entity.FoodOrder;
import com.cloudhubs.trainticket.user.entity.Travel;
import com.cloudhubs.trainticket.user.entity.TravelResult;
import com.cloudhubs.trainticket.user.entity.Ticket;
import com.cloudhubs.trainticket.user.entity.NotifyInfo;
import com.cloudhubs.trainticket.user.entity.User;
import com.cloudhubs.trainticket.user.entity.Seat;
import com.cloudhubs.trainticket.user.entity.Consign;
import com.cloudhubs.trainticket.user.entity.OrderStatus;
import com.cloudhubs.trainticket.user.util.HeadersUtils;
import com.cloudhubs.trainticket.user.util.JsonUtils;
...
import com.cloudhubs.trainticket.user.mq.RabbitSend;
import com.cloudhubs.trainticket.user.service.PreserveService;
