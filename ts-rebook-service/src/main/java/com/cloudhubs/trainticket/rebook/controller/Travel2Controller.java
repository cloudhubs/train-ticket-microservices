...
import com.cloudhubs.trainticket.rebook.service.TravelService2;
...
public class Travel2Controller {
    ...
    public HttpEntity<?> createTrip(@RequestBody com.cloudhubs.trainticket.rebook.entity.TravelInfo routeIds, @RequestHeader HttpHeaders headers) {
        // null
    ...
    public HttpEntity updateTrip(@RequestBody com.cloudhubs.trainticket.rebook.entity.TravelInfo info, @RequestHeader HttpHeaders headers) {
        // Trip
    ...
    public HttpEntity queryInfo(@RequestBody com.cloudhubs.trainticket.rebook.entity.TripInfo info, @RequestHeader HttpHeaders headers) {
    ...
    public HttpEntity getTripAllDetailInfo(@RequestBody com.cloudhubs.trainticket.rebook.entity.TripAllDetailInfo gtdi, @RequestHeader HttpHeaders headers) {
