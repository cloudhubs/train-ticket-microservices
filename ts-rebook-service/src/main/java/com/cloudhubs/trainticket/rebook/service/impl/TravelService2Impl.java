...
import com.cloudhubs.trainticket.rebook.entity.*;
import com.cloudhubs.trainticket.rebook.repository.*;
...
public class TravelService2Impl implements TravelService2 {
    ...
    @Override
    public Response create(com.cloudhubs.trainticket.rebook.entity.TravelInfo info, HttpHeaders headers) {
    ...
    @Override
    public Response update(com.cloudhubs.trainticket.rebook.entity.TravelInfo info, HttpHeaders headers) {
        TripId ti = new TripId(info.getTripId());
    ...
    private TripResponse getTickets(Trip trip, Route route1, String startPlaceName, String endPlaceName, String departureTime, HttpHeaders headers) {
        ...
        ResponseEntity<Response<TravelResult>> re = restTemplate.exchange(
                ...
                HttpMethod.POST,
                requestEntity,
                new ParameterizedTypeReference<Response<com.cloudhubs.trainticket.rebook.entity.TravelResult>>() {
                });
        Response r = re.getBody();
        if(r.getStatus() == 0){
